...
### version bullseye008 - Mar 6, 2025   -- add timestamp to the 'extra :' error message written to tarpn_command.log.


echo -e "\n\n\n\n"  >> $TARPNCOMMANDLOGFILE
echo -ne $(date) "" >> $TARPNCOMMANDLOGFILE
echo "--VERSION--MAKE LOCAL BPQ            Bullseye008-  START" >> $TARPNCOMMANDLOGFILE
