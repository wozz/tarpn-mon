...
// Encode non-printable ASCII characters as \x## for debugging
// Preserves printable ASCII (0x20-0x7E), newlines, and tabs
export function encodeNonPrintable(input) {
    if (!input) return "";
    let result = "";
